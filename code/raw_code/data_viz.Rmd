...
# list.of.packages <- c("janitor", "ggplot2", "dplyr", "lubridate", "zoo", "forcats", "ggthemes", "knitr", "rmarkdown", "usethis")
...
pets <- read.csv("/cloud/project/seattle_pet_licenses.csv", stringsAsFactors = FALSE)
